...
const rawDatabases = {
    ...
    maccabi: {
        PG: [
            { name: "טייריס רייס", rating: 88 }, { name: "יוגב אוחיון", rating: 80 }, { name: "יובל נעימי", rating: 74 }, { name: "ג'ורדן פארמר", rating: 85 }, 
            { name: "טיילור רוצ'סטי", rating: 82 }, { name: "גל מקל", rating: 81 }, { name: "נוריס קול", rating: 84 }, { name: "פייר ג'קסון", rating: 83 }, 
            { name: "סקוטי וילבקין", rating: 92 }, { name: "נייט וולטרס", rating: 80 }, { name: "ארון ג'קסון", rating: 81 }, { name: "כריס ג'ונס", rating: 86 }, 
            { name: "קינן אוונס", rating: 89 }, { name: "יפתח זיו", rating: 76 }, { name: "לורנזו בראון", rating: 91 }, { name: "תמיר בלאט", rating: 82 }, 
            { name: "רוקאס יוקובאיטיס", rating: 84 }, { name: "סייבן לי", rating: 81 }, { name: "עומר מאייר", rating: 73 }
        ],
        SG: [
            { name: "ריקי היקמן", rating: 87 }, { name: "סילבן לנדסברג", rating: 81 }, { name: "ג'רמי פארגו", rating: 86 }, { name: "אנדרו גאודלוק", rating: 85 }, 
            { name: "די.ג'יי. סילי", rating: 80 }, { name: "דגן יבזורי", rating: 75 }, { name: "ג'ון דיברתולומיאו", rating: 82 }, { name: "מייקל רול", rating: 81 }, 
            { name: "קנדריק ריי", rating: 76 }, { name: "טיילר דורסי", rating: 85 }, { name: "פרדריק בורדיון", rating: 75 }, { name: "קיירי תומאס", rating: 77 }, 
            { name: "ווייד בולדווין", rating: 93 }, { name: "דארן היליארד", rating: 82 }, { name: "אוסטין הולינס", rating: 78 }, { name: "ג'יילן אדאמס", rating: 80 }, 
            { name: "ג'ו תומאסון", rating: 78 }
        ],
        SF: [
            { name: "ליוואי רנדולף", rating: 82 }, { name: "דווין סמית'", rating: 89 }, { name: "ג'ו אינגלס", rating: 85 }, { name: "גיא פניני", rating: 82 }, 
            { name: "נייט לינהארט", rating: 77 }, { name: "סוני ווימס", rating: 84 }, { name: "דיאנדרה קיין", rating: 81 }, { name: "יובל זוסמן", rating: 79 }, 
            { name: "כארם משעור", rating: 76 }, { name: "דני אבדיה", rating: 84 }, { name: "אלייז'ה בראיינט", rating: 83 }, { name: "סנדי כהן", rating: 74 }, 
            { name: "ג'יימס נאנלי", rating: 85 }, { name: "בונזי קולסון", rating: 88 }, { name: "רפי מנקו", rating: 78 }, { name: "אנטוניוס קליבלנד", rating: 80 }, 
            { name: "מריאל שאיוק", rating: 81 }, { name: "קית לנגפורד", rating: 88 }
        ],
        PF: [
            { name: "דייוויד בלו", rating: 86 }, { name: "ג'ייק כהן", rating: 79 }, { name: "בריאן רנדל", rating: 84 }, { name: "ג'ו אלכסנדר", rating: 78 }, 
            { name: "דראגן בנדר", rating: 77 }, { name: "ויקטור ראד", rating: 79 }, { name: "קווינסי מילר", rating: 82 }, { name: "ג'ונה בולדן", rating: 80 }, 
            { name: "ג'וני אובראיינט", rating: 81 }, { name: "אנג'לו קלויארו", rating: 79 }, { name: "עומרי כספי", rating: 84 }, { name: "קווינסי אייסי", rating: 78 }, 
            { name: "עוז בלייזר", rating: 76 }, { name: "טי.ג'יי. קליין", rating: 75 }, { name: "דריק ויליאמס", rating: 82 }, { name: "אלכס פוית'רס", rating: 83 }, 
            { name: "ג'רל מרטין", rating: 80 }, { name: "סולימאן בריימו", rating: 78 }, { name: "ג'יימס ווב", rating: 79 }, { name: "ג'יילן הורד", rating: 81 }, 
            { name: "וויל ריימן", rating: 74 }
        ],
        C: [
            { name: "שון ג'יימס", rating: 86 }, { name: "סופוקליס שחורציאניטיס", rating: 87 }, { name: "אלכס טיוס", rating: 85 }, { name: "אנדריאה ז'יז'יץ'", rating: 78 }, 
            { name: "בן אלטיט", rating: 72 }, { name: "טרבור אמבקווה", rating: 80 }, { name: "ויטור פאבראני", rating: 77 }, { name: "איתי שגב", rating: 75 }, 
            { name: "ריצ'רד הנדריקס", rating: 83 }, { name: "ארינזה אונואקו", rating: 76 }, { name: "סדריק סימונס", rating: 75 }, { name: "קולטון אייברסון", rating: 78 }, 
            { name: "מאיק צירבס", rating: 81 }, { name: "נמרוד לוי", rating: 76 }, { name: "טאריק בלאק", rating: 84 }, { name: "אותלו האנטר", rating: 85 }, 
            { name: "ג'יילן ריינולדס", rating: 84 }, { name: "אמארה סטודמאייר", rating: 82 }, { name: "אנטה ז'יז'יץ'", rating: 85 }, { name: "מת'יאס לסור", rating: 88 }, 
            { name: "רומן סורקין", rating: 84 }, { name: "ג'וש ניבו", rating: 87 }, { name: "חסיאל ריברו", rating: 82 }, { name: "ווניין גבריאל", rating: 81 }
        ]
    }
};

const processedDBs = { nba: {}, maccabi: {} };
let globalId = 1;

for (const dbName in rawDatabases) {
    for (const position in rawDatabases[dbName]) {
        processedDBs[dbName][position] = rawDatabases[dbName][position].map(player => ({
            id: globalId++,
            name: player.name,
...
function initializeGamePlayers(dbName) {
    let selectedPlayers = [];
    const shuffleArray = (array) => array.sort(() => 0.5 - Math.random());
    const numPlayersPerPosition = gameState.participants.length;
    
    const targetDB = (processedDBs[dbName] && processedDBs[dbName].PG.length > 0) ? processedDBs[dbName] : processedDBs['nba'];

    for (const position in targetDB) {
        const shuffledPosition = shuffleArray([...targetDB[position]]);
...
io.on('connection', (socket) => {
    ...
    socket.on('startGame', (dbSelection) => {
        if (!gameState.gameStarted && gameState.participants.length > 0) {
            gameState.gameStarted = true;
            gameState.auctionIndex = 0;
            gameState.activeDB = dbSelection || 'nba';
            initializeGamePlayers(gameState.activeDB);
            startNextAuction();
        }
    });
